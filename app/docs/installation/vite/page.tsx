...
export const metadata: Metadata = {
  title: "Install Layout UI in Vite",
  description: "Step-by-step guide to adding Layout UI components to a Vite + React project using the shadcn registry CLI.",
  alternates: { canonical: `${SITE_URL}/docs/installation/vite` },
};
